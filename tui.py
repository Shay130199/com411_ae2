def welcome():
    """
    Task 1: It must display a welcome message.It must have the title
    'Solar Record Management System' surrounded by 30 dashes on each side of the title.
     It has to be an equal amount of characters ('-'). No returns are included.
...
def menu():
    """
    Task 2: A menu should be displayed with options such as
    'Load Data', 'Process Data', 'Visualise Data', 'Save Data' and 'Exit'
    The user should response and should be returned as an integer corresponding
    to the selected option.

    For example:
    - 1 for 'Load Data'
    - 2 for 'Process Data'
    - 3 for 'Visualise Data'
    - 4 for 'Save Data'
    - 5 for 'Exit'


    If the user enters a invalid option such as a number outside of the 1-5 range, for example
    '6'.A suitable error message. Nothing should be returned.
    ...
    if response == 1:
        print("Data Loading has started")
...
def started(operation):
    """
    Task 3: Display a message to tell the user the operation has started.
    The function should display a message in the following format:
    '{operation} has started.'Where {operation} is the value of the parameter passed
    to this function.
...
def process_type():
    ...
    def process_type():
        ...
        print(f" Please Select an option:")
        print()
        print("1. [1] Retrieve entity")
        print("2. [2] Retrieve entity details")
        print("3. [3] Categorise entities by type")
        print("4. [4] Categorise entities by gravity")
        print("5. [5] Summarise entities by orbit")
        print()

        response = int(input("Please enter a number 1-5: "))
        ...
        if response == 1:
            ...
            input("Warning Error: invalid Selection!")
...
def entity_name():
    ...
    """
    entity = str(input("Please input entity..."))
    print(entity)
...
def entity_details():
    ...
    entity = str(input("Please input entity..."))
    print()
    indexes = str(input("Enter a list of odd indexes"))
    print()
    print(entity, indexes)
